    ...
    void draw(float x1,float x2, float y1, float y2,int n,int c )
{
      ...
      // if(n%2!=0)
       ...
       //x4 = x2;
       //y4 = y2-x;
       x3 = ((x*4.2 * cos(29.85)) - (y*4.2 * sin(29.85))) + x1;
       y3 = ((y*4.2 * cos(29.85)) + (x*4.2 * sin(29.85))) + y1;
       x4 = ((x*4.2 * cos(29.85)) - (y*4.2 * sin(29.85))) + x2;
       y4 = ((y*4.2 * cos(29.85)) + (x*4.2 * sin(29.85))) + y2;
       
       x5 = ((x*sqrt(2)/2 * cos(30.635)) - (y*sqrt(2)/2 * sin(30.635))) + x3;
       y5 = ((y*sqrt(2)/2 * cos(30.635)) + (x*sqrt(2)/2 * sin(30.635))) + y3;
       cl=COLOR(180-n*45,n*20,0);
      ...
      // setcolor( cl);
       setfillstyle(1,cl);
       //if(n%2==1)
       if(n<6)floodfill((x4+x1)/2,(y4+y1)/2,cl);
